        ...
        <div className="w-full px-4 lg:px-6">
          <div className="flex items-center justify-between h-12">
            ...
            <div className="flex items-center gap-1">
              ...
              <a
                href="https://discord.gg/QvasmfKD"
                target="_blank"
                rel="noopener noreferrer"
                className="p-2 text-zinc-500 hover:text-white transition-colors flex-shrink-0"
                title="Join Discord"
              >
                <svg viewBox="0 0 71 55" className="h-4 w-4" fill="currentColor" style={{ width: '16px', height: '12px' }}>
                  <path d="M60.104 4.897c-5.459-2.448-11.633-4.261-18.115-5.26-.555-.085-1.112.145-1.35.65l-2.124 4.482c-.89-.2-1.79-.38-2.696-.535-.659-.099-1.324-.185-1.995-.257-.219-.03-.439-.058-.661-.084-.23-.027-.46-.05-.693-.067-.263-.02-.526-.034-.791-.044-.23-.008-.463-.013-.697-.013H29.01c-.259 0-.512.008-.765.015-.213.007-.427.015-.64.03-.259.015-.519.034-.777.055-.222.02-.44.042-.657.067-.216.025-.432.053-.646.084-.207.03-.413.063-.617.099-.223.04-.445.082-.664.13-.019.003-.037.007-.056.01-6.318 1.116-12.163 2.842-17.352 5.128-.411.188-.676.59-.676 1.038v36.636c0 .454.279.884.706 1.07 4.868 2.178 9.994 3.834 15.304 4.938.428.09.87.16 1.315.22.19.025.38.05.572.07.402.043.81.077 1.223.1.193.012.388.02.583.027.288.01.577.015.866.015h.006c.259 0 .51-.006.758-.015.266-.008.53-.02.788-.034.244-.013.486-.03.724-.05.237-.02.47-.043.697-.07.21-.025.415-.053.614-.083.225-.033.445-.07.659-.112.19-.037.374-.078.552-.123.19-.048.374-.1.551-.155.006 0 .013-.003.02-.005 5.314-1.104 10.44-2.76 15.308-4.938.427-.186.706-.616.706-1.07V5.935c0-.448-.265-.85-.676-1.038zM23.725 37.325c-3.607 0-6.534-3.006-6.534-6.713s2.927-6.713 6.534-6.713c3.608 0 6.534 3.006 6.534 6.713s-2.926 6.713-6.534 6.713zm23.55 0c-3.607 0-6.534-3.006-6.534-6.713s2.927-6.713 6.534-6.713c3.608 0 6.534 3.006 6.534 6.713s-2.926 6.713-6.534 6.713z"/>
                </svg>
              </a>
