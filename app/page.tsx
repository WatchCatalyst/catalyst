          ...
          <div className="flex items-center justify-between h-12">
            ...
            <div className="flex items-center gap-1">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="px-2.5 py-2 text-zinc-500 hover:text-white transition-colors flex-shrink-0"
                title="Join Discord"
              >
                <svg viewBox="-2 -2 28 28" className="h-4 w-4" fill="currentColor" style={{ width: '16px', height: '16px' }}>
                  <path d="M20.317 4.37a19.791 19.791 0 0 0-4.885-1.515.074.074 0 0 0-.079.037c-.21.375-.444.864-.608 1.25a18.27 18.27 0 0 0-5.487 0 12.64 12.64 0 0 0-.617-1.25.077.077 0 0 0-.079-.037A19.736 19.736 0 0 0 3.677 4.37a.07.07 0 0 0-.032.027C.533 9.046-.32 13.58.099 18.057a.082.082 0 0 0 .031.057 19.9 19.9 0 0 0 5.993 3.03.078.078 0 0 0 .084-.028c.462-.63.874-1.295 1.226-1.994a.076.076 0 0 0-.041-.106 13.107 13.107 0 0 1-1.872-.892.077.077 0 0 1-.008-.128 10.2 10.2 0 0 0 .372-.292.074.074 0 0 1 .077-.01c3.928-1.793 6.4-2.221 8.548-2.272a.076.076 0 0 1 .08.028c.464.63.874 1.295 1.226 1.994a.076.076 0 0 1-.041.106c-.53.24-1.065.44-1.608.613a.077.077 0 0 0-.008.127 10.5 10.5 0 0 0 .372.292.074.074 0 0 0 .078.009 19.839 19.839 0 0 0 6.002-3.03.077.077 0 0 0 .032-.054c.5-5.177-.838-9.674-3.549-13.66a.061.061 0 0 0-.031-.03zM8.02 15.33c-1.183 0-2.157-1.085-2.157-2.419 0-1.333.956-2.419 2.157-2.419 1.21 0 2.176 1.096 2.157 2.42 0 1.333-.956 2.418-2.157 2.418zm7.975 0c-1.183 0-2.157-1.085-2.157-2.419 0-1.333.955-2.419 2.157-2.419 1.21 0 2.176 1.096 2.157 2.42 0 1.333-.946 2.418-2.157 2.418z"/>
                </svg>
              </a>
